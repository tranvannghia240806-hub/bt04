...
<<<<<<< HEAD
            if (name == null || name.trim().isEmpty()
                    ...
                    || quantity < 0) {
                resp.sendRedirect(req.getContextPath() + "/admin/product/add?error=validation");
                return;
            }
            Product product = new Product(name.trim(), price, description, image, quantity, new Date(), category);
=======
